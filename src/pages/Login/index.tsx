      ...
      <InputContainer>
        ...
        <TwoInput>
          ...
          <ContainerImputs style={{ marginTop: "10px" }}>
            <IconSpace style={{ marginLeft: "7px", marginTop: "-4px" }}>
              {" "}
              <Image source={LockImage} style={{ width: 25, height: 25 }} />
            </IconSpace>

            <EyeSpace onPress={() => setPasswordVisible(!passwordVisible)}>
              {" "}
              <Image
                source={passwordVisible ? OlhoCortado : myImage}
      ...
      <ButtonContainer>
        <Button
          ...
          <IconSpace style={{ marginLeft: "70px" }}>
            {validEmail.test(emailValue) && senhaValue.length >= 8 ? (
              <Image source={EnterWhite} style={{ width: 25, height: 25 }} />
            ) : (
              <Image source={EnterIcon} style={{ width: 25, height: 25 }} />
            )}{" "}
          </IconSpace>
          Entrar
        </Button>
